...
1. **Basic Workflow**
   ...
   - Action: Checkout code, prints a message "Hello, CI with GitHub Actions!" to the logs.
...
3. **Scheduled Workflow**
   ...
   - Action: Checkout code, prints a message indicating successful completion.

4. **Matrix Build Workflow**
   - Trigger: On every push to the `main` branch.
   - Action: Runs unit tests across multiple Python versions (3.8, 3.9, 3.11, and 3.12).
